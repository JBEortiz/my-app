...
const HomePage= () => {
  ...
  <header className="relative bg-blue-gray-800 pb-36">
    ...
    <div className="relative mx-auto mt-24 max-w-md px-4 pb-32 sm:max-w-3xl sm:px-6 md:mt-32 lg:max-w-7xl lg:px-8">
      <h1 className="text-4xl font-bold tracking-tight text-stone-700 md:text-5xl lg:text-6xl">Saludos, soy
      <br></br>
       Juan Berenguer Ortiz</h1>
      <p className="mt-6 max-3xl text-xl text-white font-blod">
        presentacion chat GPT
      </p>
    </div>
  </header>
  ...
  <main>
    <div className="bg-blue-gray-50">
          ...
          {supportLinks.map((link) => (
            <div key={link.name} className="flex flex-col rounded-2xl bg-white shadow-xl">
              <div className="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                ...
                <h3 className="text-xl font-mono text-blue-gray-900">{link.name}</h3>
              ...
              <div className="rounded-bl-2xl rounded-br-2xl bg-blue-gray-50 p-6 md:px-8">
                <a href={link.href} className="text-base font-mono text-blue-700 hover:text-blue-600">
                  Contact us
      ...
      >
        <h2 className="text-3xl font-mono tracking-tight text-blue-gray-900" id="faq-heading">
    ...
    <section className="relative bg-white" aria-labelledby="join-heading">
      ...
      <div className="mx-auto max-w-7xl bg-blue-600 lg:bg-transparent lg:px-8">
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-gradient-to-r from-blue-400 to-blue-500 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              <h2 className="text-3xl font-blod tracking-tight text-white" id="join-heading">
                Join our team
              </h2>
              ...
              <a
                className="block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-mono text-blue-500 shadow-md hover:bg-blue-gray-50 sm:inline-block sm:w-auto"
                href="#"
              >
    ...
    {/* Newsletter Section */}
    <section
      className="mx-auto max-w-md py-15 px-2 sm:max-w-2xl sm:px-6 lg:flex lg:max-w-7xl lg:items-center lg:py-32 lg:px-8"
